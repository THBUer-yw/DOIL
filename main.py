...
if __name__ == "__main__":
	...
	parser.add_argument('--gail_epoch', type=int, default=100, help='gail epochs (default: 5)')
	parser.add_argument('--gail_prepoch', type=int, default=200, help='gail prepochs (default: 50)')
