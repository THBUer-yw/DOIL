...
class TD3(object):
    def __init__(
        ...
        self.actor = actor_prototype(state_dim, action_dim, max_action).to(self.device)
        self.actor_target = copy.deepcopy(self.actor)
        self.actor_optimizer = torch.optim.Adam(self.actor.parameters(), lr=3e-4)

        critic_prototype = D2RLCritic

        self.critic = critic_prototype(state_dim, action_dim).to(self.device)
    ...
    def train(self, args, replay_buffer, writer, steps):
        self.total_it += 1
